@echo off
REM David vs Lion and Bear launcher. English-only (Chinese breaks .bat parsing on Windows).
setlocal enableextensions
title David vs Lion and Bear
cd /d "%~dp0"

echo ============================================
echo    David vs Lion and Bear  -  starting...
echo ============================================
echo.
